...
var style_rates_20052010_14 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (value >= -100.000000 && value <= -0.250000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
            ...
            style = [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(248,242,141,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 0.988}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })]
