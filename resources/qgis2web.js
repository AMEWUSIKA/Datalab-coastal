...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Evolution du Trait de côte</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (385 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '<br />Ce webmapping interactif visualise l’évolution de la ligne côtière du Togo sur plusieurs décennies, à partir d’analyses multi-temporelles d’images satellitaires. Les utilisateurs peuvent comparer le trait de côte à différentes dates, repérer les secteurs d’érosion ou d’accumulation et mieux comprendre les dynamiques littorales pour soutenir une gestion durable du littoral togolais.';
            }
